...
return (
<>
<div id="contact" className="bg-gradient-to-b from-gray-300 to-white flex flex-col justify-center items-center lg:pt-20 pt-10">
...
<div className='md:justify-between flex flex-col justify-items-center md:max-w-xl w-full gap-10'>
