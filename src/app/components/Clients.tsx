...
return (
<>
  <section className="bg-gradient-to-b from-gray-300 to-white flex justify-center items-center px-3 lg:px-0 lg:pt-32 pt-10">
  ...
  <section className="flex justify-center items-center px-4 lg:px-0 lg:pt-14 pt-10 pb-10 lg:pb-20">
    <div className='md:justify-between flex flex-col justify-items-center md:max-w-6xl w-full'>
